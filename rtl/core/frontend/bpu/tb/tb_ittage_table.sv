...
module tb;
  ...
  localparam logic [VA_WIDTH-1:0] PC_B = VA_WIDTH'('h00_0000_2040);
  localparam logic [VA_WIDTH-1:0] PC_C = VA_WIDTH'('h00_0000_0140);
  localparam logic [VA_WIDTH-1:0] PC_D = VA_WIDTH'('h00_0000_00C0);
  localparam logic [VA_WIDTH-1:0] PC_E = VA_WIDTH'('h00_0000_0080);
  ...
  initial begin
    ...
    alc_wd_u0[0] = {8'h10, IT_MAX_TGT_WIDTH'('h55), 2'b10, 2'b01, 3'b100, 1'b1};
    ittage_pred_inp_p0[0].pc = PC_A;
    @(posedge clk); #1;
    ...
    alc_wd_u0[0] = {8'h01, IT_MAX_TGT_WIDTH'('hAA), 2'b00, 2'b00, 3'b100, 1'b1};
    ...
    prm_tgt_wr_u0[0]     = 1;
    prm_tbl_sel_u0[0]    = TBL_SEL_W'(1);
    tgt_wd_u0[0]         = IT_MAX_TGT_WIDTH'('h1234);
    upd_index_u0[0]      = 8'h10;
    ittage_pred_inp_p0[0].pc = PC_A;
    @(posedge clk); #1;
    ittage_upd_val_u0[0] = 0;
    ...
    alc_index_u0[0]      = 8'h50;
    alc_wd_u0[0] = {8'hFF, IT_MAX_TGT_WIDTH'('hFF), 2'b11, 2'b11, 3'b111, 1'b1};
    ittage_pred_inp_p0[0].pc = PC_C;
    @(posedge clk); #1;
    ittage_upd_val_u0[0] = 0;
    alc_wr_u0[0]         = 0;
    ...
    tbl_ri_wr     = 1;
    tbl_ri_wa     = 8'h30;
    tbl_ri_wd = {8'h00, IT_MAX_TGT_WIDTH'('hCC), 2'b11, 2'b01, 3'b110, 1'b1};
    ...
    alc_wd_u0[0] = {8'h00, IT_MAX_TGT_WIDTH'('hAA), 2'b01, 2'b01, 3'b101, 1'b1};
    alc_wd_u0[1] = {8'h00, IT_MAX_TGT_WIDTH'('hBB), 2'b10, 2'b10, 3'b010, 1'b1};
